function calculateArea() {
    ...
    var frontfive = 1/4*empireRound+4;
    ...
    document.getElementById("frontresult4").innerHTML = "(3-4) 1/4*bustRound + 1cm(ease)=  " + frontfour+"cm";
    document.getElementById("frontresult5").innerHTML = "(1-5) 1/4*empireRound+4cm(dart) =  " + frontfive+"cm";
    ...
    document.getElementById("frontresult9").innerHTML = "(0-8) Back Neck Depth = 15cm or as desired and shape neckline curve ";
    document.getElementById("frontresult10").innerHTML = "(2-9) = Shoulder Slope = 0.5cm";
    document.getElementById("frontresult11").innerHTML = "(6-10) = 2cm and Join 2 to 10 with a straight line";
    document.getElementById("frontresult12").innerHTML = "(10-11) = 2cm and join (9-11-4) with a curve";
    document.getElementById("frontresult13").innerHTML = "Belt width = (1-12) = 1/12 BustRound " + fronteight+"cm";
    document.getElementById("frontresult14").innerHTML = "(5-13) = 1 to 12 minus 1.5cm = "+fronttwelve+"cm and join 12 and 13 using a curve";
    document.getElementById("frontresult15").innerHTML = "(1-14) = 1/4 Empire Round ="+frontthirteen+"cm and Square up from 14 to 15";
    document.getElementById("frontresult16").innerHTML = "(0-16) = Apex Level = "+frontfourteen+"cm";
    document.getElementById("frontresult17").innerHTML = "(16-17) = 1/12 Bust Round + 1cm = "+front15+"cm";
    document.getElementById("frontresult18").innerHTML = "11 is deepest point of armhole, join (11-17) with a dotted line."
    document.getElementById("frontresult19").innerHTML = "(17-18) = 3cm"
    document.getElementById("frontresult20").innerHTML = "(11-a),(11-b)=0.5cm, Join 18-a,18-b"
    document.getElementById("frontresult21").innerHTML = "(17-19) = 2cms.Square down from 19 to 20"
    document.getElementById("frontresult22").innerHTML = "(20-c)=(20-d)=2cms. Draw the dart"
    document.getElementById("frontresult23").innerHTML = "(17-21) = 2cms"
    document.getElementById("frontresult24").innerHTML = "(16-e),(16-f) = 1cm. Draw the dart = 2cms"
    document.getElementById("frontresult25").innerHTML = "Join (21-e), (21-f)"
    document.getElementById("frontresult26").innerHTML = "(4-22) = 10cm"
    document.getElementById("frontresult27").innerHTML = "Join (17-22) with a dotted line"
    document.getElementById("frontresult28").innerHTML = "(17-23) = 3cm"
    document.getElementById("frontresult29").innerHTML = "22-g,22-h = 1cm. Draw the dart"
    document.getElementById("frontresult30").innerHTML = "<b>Cutting Points:</b>";
    document.getElementById("frontresult31").innerHTML = "Front Draft : (8-7-9-4-13-12-8) Cut: 2pcs"
    document.getElementById("frontresult32").innerHTML = "Belt/Yoke : (1-12-15-14-1) Cut: 4pcs"
